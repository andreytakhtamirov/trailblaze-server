...
class OptionsResolver {
    ...
    setDistanceInfluence() {
        if (!this.isRoundTrip) {
            this.options.custom_model.distance_influence = this.parsedData.influence ?? 1000000;
        }
    }

    setGeometry() {
        if (!this.isRoundTrip) {
            this.options.custom_model.areas.features[0].geometry = this.parsedData.ignore_area || this.defaultGeometry;
        } else {
            this.options.custom_model.areas.features[0].geometry = this.defaultGeometry;
        }
    }
